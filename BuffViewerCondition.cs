...
namespace PermanentBuffViewer
{
    public class BuffViewerCondition
    {
        ...
        public static Condition UsedVitalCrystal = new Condition("Mods.PermanentBuffViewer.Conditions.UsedVitalCrystal", () => Main.LocalPlayer.usedAegisCrystal);
        ...
        public static Condition UsedTorchGod = new Condition("Mods.PermanentBuffViewer.Conditions.UsedArtisanLoaf", () => Main.LocalPlayer.unlockedBiomeTorches);
